...
CTerrainTex* CTerrainTex::Create(LPDIRECT3DDEVICE9 graphicDev, const _ulong& dwCntX, const _ulong& dwCntZ,
    const _ulong& dwVtxItv)
{
    CTerrainTex* pTerainTex = new CTerrainTex(graphicDev);

    if (FAILED(pTerainTex->Ready_Buffer(dwCntX, dwCntZ, dwVtxItv)))
    {
